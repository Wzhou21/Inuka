...
var colourBtnList=document.getElementById("colourBtnList");
var zoomBtnList=document.getElementById("zoomBtnList");
...
var isMouseDown=false;
  ...
  if (colourBtnList.style.display === "none") {
    ...
    brsuhContainer.style.display="block";
        ...
        $("#redPen").click(function(){ mode="redpen";});
        $("#greenPen").click(function(){ mode="greenpen";});
        $("#bluePen").click(function(){ mode="bluepen";});
        $("#eraseBtn").click(function(){ mode="erase";});  
 }

//=================================================================================================
function startZoom(){
      if (zoomBtnList.style.display === "none") {
         mode="undefine";
        zoomBtnList.style.display = "block";
    } else {
        zoomBtnList.style.display = "none";
    }
}
//=================================================================================================
...
//=================================================================================================
function ZoomFun(increment){
    console.log("Zoomed to " + (increment * 100) + "%.");
            img.src = imagePath;
             blank.src = "White.jpeg";
            img.onload = function(){           
        if(img.height > img.width){ //Centralises image
            ...
            var editedWidth = widthOverHeightRatio * (canvas.width - 20);
            var imgPosition = (canvas.width - editedWidth) / 2;
            ctx.drawImage(img,imgPosition,10,(editedWidth * increment),((canvas.height - 20) * increment));
        }
        else{
            ctx.drawImage(blank,0,0,canvas.width,canvas.height);
            var heightOverWidthRatio = img.height/img.width;
            var editedHeight = heightOverWidthRatio * (canvas.height - 20);
            var imgPosition = (canvas.height - editedHeight) / 2;
            ctx.drawImage(img,10,imgPosition, ((canvas.width - 20) * increment), (editedHeight * increment));
        }
    }
}
//=================================================================================================
