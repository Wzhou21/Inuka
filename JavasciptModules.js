...
reader.onload = function(e)
 {
                ...
                img.onload=function()
                {
                    ...
                    if(img.height >img.width)
                    {
                        ...
                        console.log("Resized Image Width: " + editedWidth + " Resized Image Height: " + (canvas.height - 20));
                    }else{
                        ...
                        console.log("Resized Image Width: " + (canvas.width - 20) + " Resized Image Height: " + editedHeight);
                    }
                };
            };
...
link.href = canvaslayer2.toDataURL("image/png",1).replace("image/png", "image/octet-stream");;
link.click();
document.getElementById("file-upload").value = "";
}
//=================================================================================================
function startExport(){
var canvasExport=document.createElement('canvas');
var ctxExport =canvasExport.getContext('2d');
var link = document.createElement('a');

canvasExport.width=945;
canvasExport.height=717;
document.getElementById("file-upload").value = "";
console.log("Canvas Export Width: "+ canvasExport.width + ": Canvas Export Height: " + canvasExport.height);

ctx.drawImage(canvaslayer2,0,0);//Combine Context
ctxExport.drawImage(canvas,10,87,630,478,0,0,canvasExport.width,canvasExport.height);

link.download = document.getElementById('uploadText').value;
link.href = canvasExport.toDataURL("image/jpg",1).replace("image/jpg", "image/octet-stream");
link.click();
